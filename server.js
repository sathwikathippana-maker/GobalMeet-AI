...
io.on("connection", (socket) => {
  ...
  // Handle subtitle text and relay it to other connected clients
  socket.on("subtitleText", (subtitleData) => {
    console.log("Subtitle received from", userName, ":", subtitleData.text);
    // Broadcast subtitle to all other connected clients except the sender
    socket.broadcast.emit("subtitleText", {
