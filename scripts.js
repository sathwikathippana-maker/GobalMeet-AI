const userName = "Spurthy-" + Math.floor(Math.random() * 100000);
const password = "x";
document.querySelector("#user-name").innerHTML = userName;

// Create a global socket variable
window.socket = io.connect("https://192.168.29.77:8181/", {
  auth: {
    userName,
    password,
  },
...
const hangup = async () => {
  try {
    ...
    // Emit hangup event to the other peer
    if (window.socket) {
...
// Add event listeners for call and hangup buttons
